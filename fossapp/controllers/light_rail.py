...
class LightRailController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, LightRail, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, LightRail)
        # filter = and_(default_filter, LightRail.columname.ilike('%value%'))
