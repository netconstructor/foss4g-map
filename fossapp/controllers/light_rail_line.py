...
from fossapp.lib.base import BaseController
...
class LightRailLineController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, LightRailLine, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, LightRailLine)
        # filter = and_(default_filter, LightRailLine.columname.ilike('%value%'))
