...
class HotelController(BaseController):
    ...
    def __init__(self):
        self.protocol = Protocol(Session, Hotel, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Hotel)
        # filter = and_(default_filter, Hotel.columname.ilike('%value%'))
