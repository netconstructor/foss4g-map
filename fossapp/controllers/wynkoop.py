...
class WynkoopController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Wynkoop, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Wynkoop)
        # filter = and_(default_filter, Wynkoop.columname.ilike('%value%'))
