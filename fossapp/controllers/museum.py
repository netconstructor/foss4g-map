...
class MuseumController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Museum, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Museum)
        # filter = and_(default_filter, Museum.columname.ilike('%value%'))
