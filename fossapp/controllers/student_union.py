...
class StudentUnionController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, StudentUnion, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, StudentUnion)
        # filter = and_(default_filter, StudentUnion.columname.ilike('%value%'))
